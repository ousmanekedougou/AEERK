...
class HomeController extends Controller {
    ...
    public function index() 
    {
        ...
        $nouveau_total_inscrit = Etudiant::where('ancienete',1)->where('status', 0)->get();
        $nouveau_total_valider = Etudiant::where('ancienete',1)->where('status', 1)->get();
        $nouveau_total_ommis = Etudiant::where('ancienete',1)->where('status', 2)->get();
        $nouveau_total_codifier = Etudiant::where('ancienete' , 1)->where('status' , 1)->where('codifier' , 1)->get();


        $ancien_total_inscrit = Etudiant::where('ancienete',2)->where('status', 0)->get();
        $ancien_total_valider = Etudiant::where('ancienete',2)->where('status', 0)->get();
        $ancien_total_ommis = Etudiant::where('ancienete',2)->where('status', 0)->get();
        $ancien_total_codifier = Etudiant::where('ancienete' , 2)->where('status' , 1)->where('codifier' , 1)->get();
