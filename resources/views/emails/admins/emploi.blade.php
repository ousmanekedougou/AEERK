                            ...
                            <table border="0" width="590" align="center" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <p>
                                            Nous avons bien accuse reception de votre inscrition sur la portaille de recutement de l'AEERK.
                                        </p>
                                        <p>
                                            Nous vous informons que vous pouvez a tout moment consulter vos documents en passants sur la page de verifictaion.
                                            <br>
                                            Pour acceder aux donnes entrez votre numero de telephone et votre code de reference que voici <span style="color:green;font-weight:bold">{{$code}}</span> 
                                            <br>
                                            <span style="color: red;font-weight:bold">Attention : </span> ce code est privee ne le rendez pas publique.
                                        </p>
