  ...
  @section('main-content')
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <span class="btn btn-primary">La liste des filleires universités privés</span>
                        ...
                        <div class="modal-dialog modal-sm">
                          <div class="modal-content">
                            <div class="modal-header">
                              ...
                              <h4 class="modal-title">Suppression d'une filliere</h4>
                            </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                  <h4 class="modal-title">Ajouter Votre fillere du privee</h4>
                </div>
                <form action="{{ route('admin.filliere.store') }}" method="post">
                @csrf
                <div class="modal-body">
                  <input type="hidden" value="1" name="for">
                <p>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                  <h4 class="modal-title">Modifier Votre fillere privee</h4>
                </div>
