        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <p>
                <label for="">Slug de votre domaine (unique)</label>
        ...
        <div class="modal fade" id="modal-default-{{ $modal_com->id }}">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form action="{{ route('admin.domaine.update',$modal_com->id) }}" method="post">
              @csrf
              {{ method_field('PUT') }}
              <div class="modal-body">
                <p>
                ...
                <input type="text"  value="{{ old('name') ?? $modal_com->name }}" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="">
                 ...
                 <p>
                  <label for="">Slug de votre domaine (unique)</label>
                <input type="text"  value="{{ old('slug') ?? $modal_com->slug}}" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" placeholder="">
                  @error('slug')
                    <span class="invalid-feedback" role="alert">
                        <strong class="message_error">{{ $message }}</strong>
                    </span>
