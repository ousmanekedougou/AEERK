...
@section('main-content')
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Modification de la stage de {{ $edit->titre }}
      </h1>
      <!-- <ol class="breadcrumb">
        ...
        <div class="col-md-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <!-- debu du row -->
              <div class="row">
                  <form  method="Post" action="{{ route('admin.stage.update',$edit->id) }}" enctype="multipart/form-data">
              ...
              {{ method_field('PUT') }}
                ...
                <div class="form-group">
                    <label for="title">Nom de l'offre de stage</label>
              ...
              <div class="box-footer">
                <a href="{{ route('admin.stage.index') }}" class="btn btn-warning">Retoure</a>
