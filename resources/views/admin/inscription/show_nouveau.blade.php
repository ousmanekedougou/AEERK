                ...
                <div class="post">
                  ...
                  <div class="user-block">
                    ...
                    @if($show_nouveau->codifier == 0)
                      ...
                      @endif
                  <div class="pull-left">
                  <a style="margin-right:5px;" href="{{ route('admin.inscription.index') }}" class="btn btn-warning btn-xs"><i class="fa fa-share"></i> Retoure</a>
                      @if($show_nouveau->status == 1)
                      <a style="margin-right:5px;"  class="btn btn-success btn-xs" href="{{ route ('admin.codification.show',$show_nouveau->id) }}">Codifier <i class="fa fa-edit"></i></a>
                      @endif
                  </div>
