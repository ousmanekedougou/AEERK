              ...
              <div class="nav-tabs-custom mt-4">
                  <div class="row well well-sm no-shadow">
                    ...
                    <div class="col-md-7">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <a href="{{ route('admin.bourse.index') }}" class="btn btn-primary btn-block"> <i class="fa fa-arrow-left"></i> Retour</a>
                        </div>
                        <div class="col-md-6">
                          <a href="{{ route('admin.bourse.edit',$show->id) }}" class="btn btn-success btn-block"> <i class="fa fa-edit"></i> Modifier</a>
                        </div>
                      </div>
                    </div>
                  </div>
