          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <!-- remplissage de l'immeuble 39 -->
                  ...
                  @if($imb->id == $show_nouveau->immeuble_id)
                    <form action="{{ route('admin.codification.update',$show_nouveau->id) }}" method="post">
                      @csrf 
                      {{ method_field('PUT') }}
                      ...
                      <h3 class="text-center">{{ $imb->name }}</h3>
                        ...
                        <input type="submit" value="Codifier" class="btn btn-warning">
