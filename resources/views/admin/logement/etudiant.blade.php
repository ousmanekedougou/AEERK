  ...
  @section('main-content')
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <span class="btn btn-primary">{{$chambre->immeuble->name}} :
          @if($chambre->immeuble->status == 2)
            pour les anciens
          @else 
            pour les nouveaux
          @endif
        </span>
        @if($chambre->immeuble->status == 1)
                        ...
                        <div class="modal-dialog modal-sm">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <p class="text-left">
                                Etes vous sure de vouloire migret tous les etudiants qui ont codifies
                              </p>
