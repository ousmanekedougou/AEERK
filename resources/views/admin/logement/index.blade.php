...
@section('main-content')
    ...
    <section class="content">
          ...
          <div class="">
            ...
            <a class="col-lg-offset-5 pull-right btn btn-warning" data-toggle="modal" data-id="add-immeuble" data-name="add-immeuble" data-target="#modal-default-ajouter-immeuble">Ajouter un Immeuble</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        <!-- Fin de la div  -->
          ...
          <div class="">
            <div class="box-header">
            <a class="col-lg-offset-5 pull-right btn btn-warning" data-toggle="modal" data-id="add-chambre" data-name="add-chambre" data-target="#modal-default-add-chambre">Ajouter une chambre</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table text-center table-bordered table-striped">
