...
@section('main-content')
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Modification du concour {{ $edit->titre }}
      </h1>
      <!-- <ol class="breadcrumb">
        ...
        <div class="col-md-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <!-- debu du row -->
              <div class="row">
                  <form  method="Post" action="{{ route('admin.concour.update',$edit->id) }}" enctype="multipart/form-data">
              ...
              {{ method_field('PUT') }}
                ...
                <div class="form-group">
                    <label for="title">Nom de l'offre de concour</label>
              ...
              <div class="box-footer">
                <a href="{{ route('admin.concour.index') }}" class="btn btn-warning">Retoure</a>
