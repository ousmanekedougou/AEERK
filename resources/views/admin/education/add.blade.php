        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <!-- debu du row -->
              <div class="row">
                  <form  method="Post" action="{{ route('admin.realisation.store') }}" enctype="multipart/form-data">
              @csrf
                  <div class="col-lg-5">
            ...
            <div class="box-header">
              <h3 class="box-title">Description De La Realisation
            ...
            <div class="box-body pad">
                    ...
                    <textarea class="textarea" name="contenu" placeholder="" value="{{ old('contenu')  }}" class="@error('contenu') is-invalid @enderror"
