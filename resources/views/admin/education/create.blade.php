  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          ...
          <div class="" style="margin:20px 100px">
            <form role="form" style="padding:30px;" action="{{route('admin.education.store')}}" method="post" enctype="multipart/form-data">
              @csrf
              <div class="box-body">
                ...
                <div class="col-lg-8">
                  ...
                  <div class="form-group">
                    <label>Type de la documentation</label>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('lien') is-invalid @enderror" value="{{ old('lien') }}" id="lien" name="lien" placeholder="">
                    @error('lien')
                      <span class="invalid-feedback" role="alert">
                        <strong class="message_error text-danger">{{ $message }}</strong>
                      </span>
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" class="form-control @error('file') is-invalid @enderror" value="{{ old('file') }}" id="file" name="file" placeholder="">
                    @error('file')
                      <span class="invalid-feedback" role="alert">
                        <strong class="message_error text-danger">{{ $message }}</strong>
                      </span>
              ...
              <div class="box-header">
                  <h3>Description de la documentation</h3>
              </div>
