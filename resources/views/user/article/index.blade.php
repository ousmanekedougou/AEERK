					...
					<div class="row">
						...
						<div class="col-lg-8 posts-list">
							@foreach($posts as $post)
								<div class="single-post row">
									...
									<div class="col-lg-9 col-md-9 ">
										...
										<a onclick="document.getElementById('update-form-{{$post->id}}').submit();" class="genric-btn primary">Details de l'article</a>
									</div>
							...
							<!-- <div class="single-post row">
								...
								<div class="col-lg-9 col-md-9 ">
									<div class="feature-img">
										<img class="img-fluid" src="{{asset('user/img/blog/feature-img2.jpg')}}" alt="">
									</div>
									...
									<a href="{{ route('article.show',1) }}" class="primary-btn">Details de l'article</a>
								</div>
							</div>
							<div class="single-post row">
								<div class="col-lg-3  col-md-3 meta-details">
								...
								<div class="col-lg-9 col-md-9">
									<div class="feature-img">
										<img class="img-fluid" src="{{asset('user/img/blog/feature-img3.jpg')}}" alt="">
									</div>
							...
							<div class="single-post row">
								...
								<div class="col-lg-9 col-md-9">
									<div class="feature-img">
										<img class="img-fluid" src="{{asset('user/img/blog/feature-img4.jpg')}}" alt="">
									</div>
							...
							<div class="single-post row">
								...
								<div class="col-lg-9 col-md-9">
									<div class="feature-img">
										<img class="img-fluid" src="{{asset('user/img/blog/feature-img5.jpg')}}" alt="">
									</div>
						...
						<div class="col-lg-4 sidebar-widgets">
							<div class="widget-wrap">
								...
								<div class="single-sidebar-widget popular-post-widget">
									<h4 class="popular-title">Articles Pupulaire</h4>
									<div class="popular-post-list">
										<div class="single-post-list d-flex flex-row align-items-center">
											<div class="thumb">
												<img class="img-fluid" src="{{asset('user/img/blog/pp1.jpg')}}" alt="">
											</div>
											<div class="details">
										...
										<div class="single-post-list d-flex flex-row align-items-center">
											<div class="thumb">
												<img class="img-fluid" src="{{asset('user/img/blog/pp2.jpg')}}" alt="">
											</div>
											<div class="details">
										...
										<div class="single-post-list d-flex flex-row align-items-center">
											<div class="thumb">
												<img class="img-fluid" src="{{asset('user/img/blog/pp3.jpg')}}" alt="">
											</div>
											<div class="details">
										...
										<div class="single-post-list d-flex flex-row align-items-center">
											<div class="thumb">
												<img class="img-fluid" src="{{asset('user/img/blog/pp4.jpg')}}" alt="">
											</div>
											<div class="details">
