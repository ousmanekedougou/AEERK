...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" href="{{asset('user/css/css/main.css')}}">
		<link rel="stylesheet" href="{{asset('user/css/css/sidebar-themes.css')}}">
	...
	<body>
		<div class="page-wrapper toggled light-theme">
			<nav id="sidebar" class="sidebar-wrapper">
				<div class="sidebar-content">
					<!-- sidebar-brand  -->
					<div class="sidebar-item sidebar-brand text-white font-weight-bold bg-white">
						<a class="bg-white" style="width: 100%;" href="/"><img style="width: 100%;" class="img-responsive" src="{{ asset('user/img/accueil.png') }}" alt="" srcset=""></a>
					</div>
					<!-- sidebar-header  -->
					<!-- sidebar-search  -->
					...
					<div class=" sidebar-item sidebar-menu">
						<ul>
							<li class="header-menu"> <span>Pages</span> </li>
							<li class="sidebar-dropdown">
								<a href="#"> <i class="fa fa-shopping-cart"></i> <span class="menu-text">Espace etudiant</span> <span class="badge badge-pill badge-primary">4</span> </a>
								<div class="sidebar-submenu">
									<ul>
										<li> <a href="{{ route('education.index', [ 'type' =>  1 ])}}">Offres d'emplois</a></li>
										<li> <a href="{{ route('education.index', [ 'type' =>  2 ])}}">Offres de stages</a> </li>
										<li> <a href="{{ route('education.index', [ 'type' =>  3 ])}}">Bourse d'etude</a> </li>
										<li> <a href="{{ route('education.index', [ 'type' =>  4 ])}}">Examan & Concours</a> </li>
										<li> <a href="{{ route('education.index', [ 'type' =>  5 ])}}">Formations</a> </li>
									</ul>
								</div>
							</li>
							<li class="sidebar-dropdown">
								<a href="#"> <i class="fa fa-shopping-cart"></i> <span class="menu-text">Biblioteque</span> <span class="badge badge-pill badge-primary">4</span> </a>
								<div class="sidebar-submenu">
									<ul>
							...
							<li class="sidebar-dropdown">
								<a href="#"> <i class="fa fa-shopping-cart"></i> <span class="menu-text">Offres Stages</span> <span class="badge badge-pill badge-primary">4</span> </a>
								<div class="sidebar-submenu">
									<ul>
										<li> <a href="#">Setup home page layout
							...
							<li class="sidebar-dropdown">
								<a href="#"> <i class="fa fa-shopping-cart"></i> <span class="menu-text">Exament & Concours</span> <span class="badge badge-pill badge-primary">4</span> </a>
								<div class="sidebar-submenu">
									<ul>
										<li> <a href="#">Setup home page layout
							...
							<li class="sidebar-dropdown">
								<a href="#"> <i class="fa fa-shopping-cart"></i> <span class="menu-text">Bourse d'etudes</span> <span class="badge badge-pill badge-primary">4</span> </a>
								<div class="sidebar-submenu">
									<ul>
										<li> <a href="#">Setup home page layout
							...
							<li class="sidebar-dropdown">
								<a href="#"> <i class="fa fa-shopping-cart"></i> <span class="menu-text">Offres de formations</span> <span class="badge badge-pill badge-primary">4</span> </a>
								<div class="sidebar-submenu">
									<ul>
										<li> <a href="#">Setup home page layout
				...
				<div class="sidebar-footer">
					<div class="dropdown">
						...
						<div class="dropdown-menu notifications" aria-labelledby="dropdownMenuMessage">
							...
							<div class="dropdown-divider"></div> <a class="dropdown-item text-center" href="#">All notifications</a>
						</div>
					</div>
					<div>
				...
				<div class="container-fluid">
						...
						<div class="col-md-8">
							<nav aria-label="breadcrumb" class="align-items-center">
								...
								<ol class="breadcrumb d-none d-lg-inline-flex m-0">
									...
									<li class="breadcrumb-item"><a href="{{route('about.index')}}">A propos</a></li>
									<li class="breadcrumb-item"><a href="{{route('systeme.index')}}">Comment Ca marche</a></li>
									<li class="breadcrumb-item"><a href="{{route('article.index')}}">Actualite</a></li>
					...
					@foreach($documentations as $doc)
						<article class="main-content col-md-9 pr-lg-5">
							...
							<h5 class="mb-2 mt-3">{{$doc->titre}}</h5>
							<!--//title -->
							<p class="text-justify text-bold">{!! $doc->content !!}</p>
							<!-- Sep -->
							<p>Clicker  <a href="{{ $doc->lien }}" target="blank">ici</a> pour se rendre sur le site </p>
							<p>
							<a class="btn btn-success btn-block" href="{{ Storage::url($doc->file) }}"><i class="fa fa-download"> Telecharger les details</i></a>
							</p>
							<hr class="my-5">
						</article>
					@endforeach
						{{--<article class="main-content col-md-9 pr-lg-5">
							<h1 class="mb-2 mt-3">Documentation</h1>
							...
							<figure class="highlight">
								<pre><code class="language-html" data-lang="html"><span class="c">&lt;!-- As a link --&gt;</span>
									...
									<span class="nt">&lt;/nav&gt;</span></code></pre>
															...
															<hr class="my-5">
															<figure class="highlight">
																<pre><code class="language-html" data-lang="html"><span class="nt">&lt;nav</span> <span class="na">class=</span><span class="s">"navbar navbar-expand-lg navbar-light bg-light"</span><span class="nt">&gt;</span>
		...
		<script src="{{asset('user/js/js/prism.min.js')}}"></script>
		<!-- using local scripts -->
