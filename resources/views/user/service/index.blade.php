		...
		<div class="page-wrapper toggled light-theme">
			<nav id="sidebar" class="sidebar-wrapper">
				<div class="sidebar-content">
					<!-- sidebar-brand  -->
					<div class="sidebar-item sidebar-brand text-white font-weight-bold">Informations</div>
					<!-- sidebar-header  -->
					<!-- sidebar-search  -->
					...
					<div class=" sidebar-item sidebar-menu">
						<ul>
							...
							<li class="sidebar-dropdown">
								<a href="#"> <i class="fa fa-shopping-cart"></i> <span class="menu-text">Offres Emplos</span> <span class="badge badge-pill badge-primary">4</span> </a>
						...
						<div class="col-md-8">
							<nav aria-label="breadcrumb" class="align-items-center">
								...
								<ol class="breadcrumb d-none d-lg-inline-flex m-0">
									...
									<li class="breadcrumb-item"><a href="index.html">A propos</a></li>
									<li class="breadcrumb-item"><a href="index.html">Comment Ca marche</a></li>
									<li class="breadcrumb-item"><a href="index.html">Actualite</a></li>
